...
public class SpriteSheet {
	...
	public static SpriteSheet tiles = new SpriteSheet("/Textures/Sheets/Sprite Sheet.png", 256);
	public static SpriteSheet spawnTiles = new SpriteSheet("/Textures/Sheets/SpawnLevelSheet.png", 64);
